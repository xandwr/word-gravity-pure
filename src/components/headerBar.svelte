...
{#if howToPlayOpen}
    ...
    >
        <div
            ...
            tabindex="-1"
        >
            <div class="sticky top-0 bg-blue-200 p-4 flex items-center justify-between border-b-2 border-blue-300">
                <h2 id="how-to-play-title" class="text-2xl font-bold">💡 How to Play</h2>
                <button
            ...
            <div class="p-6 space-y-6">
                <section>
                    ...
                    <p>Words carry weight — drop letters, let gravity pull them into place, and claim the strongest words before the opponent (currently a bot) does.</p>
                </section>

                <section>
                    <h3 class="text-xl font-bold mb-2">How to Play</h3>
                    <ol class="list-decimal list-inside space-y-2">
                        <li><strong>Place tiles:</strong> Drag letter tiles from your hand to the board to form words.</li>
                        <li><strong>Claim words:</strong> Tap/click on any tile in a valid word to claim all tiles in that word.</li>
                        <li><strong>Score points:</strong> Each tile has a base score and multiplier. Your score is the sum of (base × multiplier) for all tiles.</li>
                        <li><strong>Gravity:</strong> After each turn, tiles fall down if there's empty space below them.</li>
                    </ol>
                </section>
                ...
                <section>
                    ...
                    <ul class="list-disc list-inside space-y-2">
                        <li><strong>Desktop:</strong> Click and drag tiles, or click to claim words</li>
                        <li><strong>Mobile:</strong> Touch and drag tiles, or tap to claim words</li>
                        <li><strong>Swap:</strong> Drag tiles to the swap button to exchange them (limited swaps)</li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <div class="space-y-1">
                        ...
                        <p><span class="font-bold" style="color: #7ef0a0;">3x</span> - Mint Green</p>
                        <p><span class="font-bold" style="color: #f9f871;">4x</span> - Yellow</p>
                        <p><span class="font-bold" style="color: #ffb347;">5x</span> - Orange</p>
                        <p><span class="font-bold" style="color: #ff7033;">6x</span> - Dark Orange (glowing)</p>
                        <p><span class="font-bold" style="color: #ff3333;">7x</span> - Red (glowing)</p>
                        <p><span class="font-bold" style="color: #a020f0;">8x</span> - Purple (glowing)</p>
                        <p><span class="font-bold" style="color: #a020f0;">9x+</span> - Transcendent (pulsing white glow)</p>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <ul class="list-disc list-inside space-y-2">
                        <li>Look for intersecting words to maximize your claims</li>
                        <li>Higher multiplier tiles are worth more points</li>
                        <li>Plan ahead - tiles fall after each turn</li>
                        <li>Use swaps strategically when you have difficult letters</li>
                    </ul>
                </section>
            </div>
        </div>
