...
export default function LetterTile({ tile, onDragStart, draggable = false }: LetterTileProps) {
  ...
  return (
    <div
      className="rounded-xl border lg:border-4 border-white bg-amber-100 text-neutral-900 w-full h-full flex flex-col items-center justify-center relative cursor-grab active:cursor-grabbing"
      draggable={draggable}
